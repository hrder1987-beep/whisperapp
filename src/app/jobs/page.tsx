        ...
        <div className="flex flex-col gap-8 mb-16">
          <div className="flex items-center justify-between gap-4">
            <div className="space-y-1">
              <h1 className="text-2xl md:text-3xl font-black text-[#1E1E23] tracking-tighter">채용 인텔리전스</h1>
              <p className="text-xs md:text-sm font-bold text-[#888]">HR 전문가만을 위한 엄선된 커리어 기회와 채용 소식</p>
            </div>
