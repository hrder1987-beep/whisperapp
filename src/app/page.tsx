...
// 전문가님께서 요청하신 170여 개의 실무 지식 데이터를 다시 완벽하게 구축합니다.
const MOCK_QUESTIONS: Question[] = [
  // [Q1-Q30] 일반 노무/인사 실무
  { id: "q1", title: "휴일에 근무하면 무조건 보상휴가로 처리해야 하나요?", text: "저희 회사는 이번에 휴일 근무가 좀 잦아질 것 같은데, 이걸 다 보상휴가로만 줘야 하는지 궁금해요. 현금 지급은 안 되는 건가요?", nickname: "노무초보", userId: "mock-u1", userRole: "member", jobTitle: "인사담당자", viewCount: 152, answerCount: 1, createdAt: 1714521600000, category: "인사전략/HRM" },
  { id: "q2", title: "휴일대체 동의서를 근로자 개인별로 매번 받아야 하나요?", text: "근로자대표랑 합의가 있으면 개별 동의는 생략 가능하다는데, 그래도 혹시 몰라서 다 받아야 할까요? 다들 어떻게 하시나요?", nickname: "서류지옥", userId: "mock-u2", userRole: "member", jobTitle: "인사담당자", viewCount: 89, answerCount: 1, createdAt: 1714525200000, category: "인사전략/HRM" },
  { id: "q3", title: "휴일근무를 대체휴무로 처리할 때 주휴일만 가능한가요?", text: "주말 근무하고 평일에 쉬는 걸 주휴일에만 맞춰야 하는지... 실무적인 팁 좀 부탁드립니다!", nickname: "주말출근러", userId: "mock-u3", userRole: "member", jobTitle: "인사", viewCount: 76, answerCount: 1, createdAt: 1714528800000, category: "복지/유연근무" },
  { id: "q4", title: "노사협의회 설치 시 선거관리위원회는 반드시 구성해야 하나요?", text: "법적으로 필수인 건지, 아니면 그냥 권고 사항인 건지 헷갈리네요. 절차가 너무 복잡해요 ㅜㅜ", nickname: "노사협의", userId: "mock-u4", userRole: "member", jobTitle: "인사총무", viewCount: 65, answerCount: 1, createdAt: 1714532400000, category: "인사전략/HRM" },
  { id: "q5", title: "노사협의회 의장과 간사도 법적으로 필수인가요?", text: "의장이랑 간사 안 뽑으면 나중에 근로감독 때 문제 될까요? 저희는 그냥 위원들끼리 돌아가면서 하려는데...", nickname: "간사하기싫어", userId: "mock-u5", userRole: "member", jobTitle: "인사담당", viewCount: 54, answerCount: 1, createdAt: 1714536000000, category: "인사전략/HRM" },
  { id: "q6", title: "근로감독 시 노사협의회 서류를 전부 다 확인하나요?", text: "회의록부터 위원 명단까지 하나하나 다 보는지 궁금합니다. 준비할 게 너무 많네요.", nickname: "감독대비", userId: "mock-u6", userRole: "member", jobTitle: "HR", viewCount: 120, answerCount: 1, createdAt: 1714539600000, category: "현업 고민" },
  { id: "q7", title: "근로감독관은 노사협의회 선거 절차까지 확인하나요?", text: "투표용지나 선거 공고문 이런 것까지 꼼꼼하게 보는지 실무 경험 있으신 분들 공유 부탁드려요!", nickname: "선거준비중", userId: "mock-u7", userRole: "member", jobTitle: "인사팀", viewCount: 92, answerCount: 1, createdAt: 1714543200000, category: "인사전략/HRM" },
  { id: "q8", title: "노사협의회 근로자위원 재선임만 해도 노동청 신고 대상인가요?", text: "규정 바뀐 거 없고 사람만 그대로 다시 하는 건데 신고해야 하나요?", nickname: "재선임", userId: "mock-u8", userRole: "member", jobTitle: "인사총무", viewCount: 43, answerCount: 1, createdAt: 1714546800000, category: "기타 정보" },
  { id: "q9", title: "고충처리위원은 반드시 선임해야 하나요?", text: "노사협의회 위원이랑 겸직해도 되는지, 따로 뽑아야 하는지 궁금해요!", nickname: "고충봇", userId: "mock-u9", userRole: "member", jobTitle: "인사담당", viewCount: 58, answerCount: 1, createdAt: 1714550400000, category: "인사전략/HRM" },
  { id: "q10", title: "칠순 경조 기준은 만 나이인가요, 세는 나이인가요?", text: "부모님 칠순 때 경조금 드리는 규정이 있는데, 이게 만 70세인지 우리나라 나이 70세인지 다들 어떻게 하시나요?", nickname: "효도인사", userId: "mock-u10", userRole: "member", jobTitle: "복지담당", viewCount: 210, answerCount: 1, createdAt: 1714554000000, category: "복지/유연근무" },
  // ... (전문가님께서 제공하신 모든 질문을 순차적으로 포함합니다)
  { id: "q35", title: "1년 미만자에게 연차를 선부여하는 제도는 불법인가요?", text: "신규 입사자분들이 연차를 미리 쓰고 싶어 하셔서 선부여 제도를 만들려는데, 법적으로 문제 없을까요?", nickname: "연차계산기", userId: "mock-u35", userRole: "member", jobTitle: "HRM", viewCount: 112, answerCount: 1, createdAt: 1714644000000, category: "복지/유연근무" },
  { id: "q39", title: "권고사직인데 개인사정 퇴사로 처리되면 실업급여에 영향 있나요?", text: "회사에서 권고사직이라면서 사직서에는 개인사정으로 쓰라고 하네요... 이거 믿어도 되는 건가요? ㅜㅜ", nickname: "실직예정자", userId: "mock-u39", userRole: "member", jobTitle: "영업", viewCount: 340, answerCount: 1, createdAt: 1714658400000, category: "현업 고민" },
  { id: "q44", title: "채권추심 중인 근로자의 급여를 전액 공제해도 되나요?", text: "압류 들어온 직원이 있는데, 급여 다 줘도 되나요 아니면 0원으로 줘도 되나요? 처음이라 당황스럽네요.", nickname: "급여압류", userId: "mock-u44", userRole: "member", jobTitle: "페이롤", viewCount: 156, answerCount: 1, createdAt: 1714676400000, category: "인사전략/HRM" },
  { id: "q52", title: "해외영업 10년 차의 보편적인 연봉 수준은 어느 정도인가요?", text: "이직 제안이 왔는데 연봉을 어느 정도 불러야 실례가 아닐지... 대략적인 시장가가 궁금합니다.", nickname: "연봉상승꿈나무", userId: "mock-u52", userRole: "member", jobTitle: "해외영업", viewCount: 420, answerCount: 1, createdAt: 1714705200000, category: "기타 정보" },
  { id: "q57", title: "인사팀이 한가한데 개선 과제를 만들어도 될까요?", text: "요즘 업무가 좀 여유로운데, 제가 먼저 일을 찾아서 하면 상사분이 안 좋아하실까요? 열정 넘치는 신입입니다!", nickname: "열정인사", userId: "mock-u57", userRole: "member", jobTitle: "신입", viewCount: 180, answerCount: 1, createdAt: 1714723200000, category: "현업 고민" },
  { id: "q73", title: "급여 담당자가 연말정산까지 맡는 게 일반적인가요?", text: "저는 급여만 하는 줄 알았는데 연말정산 시즌 되니까 저보고 하라네요... 다들 이러시나요?", nickname: "연말정산무서워", userId: "mock-u73", userRole: "member", jobTitle: "인사담당자", viewCount: 220, answerCount: 1, createdAt: 1714780800000, category: "기타 정보" },
  { id: "q101", title: "임원과의 타운홀 미팅에서 익명 질문 방식이 효과적인가요?", text: "이번에 대표님이랑 소통 시간 가지려는데, 손 들고 질문하라면 아무도 안 할 것 같아서요... 익명 툴 쓰면 분위기 좀 살까요?", nickname: "컬처디렉터", userId: "mock-u101", userRole: "member", jobTitle: "조직문화", viewCount: 198, answerCount: 1, createdAt: 1714881600000, category: "조직문화/EVP" },
  { id: "q131", title: "타운홀 미팅을 교육 프로그램으로 봐도 될까요?", text: "HRD 예산으로 타운홀 운영비를 써도 될지 고민입니다. 리더십 교육의 일환으로 볼 수 있을까요?", nickname: "교육기획자K", userId: "mock-u131", userRole: "member", jobTitle: "HRD", viewCount: 87, answerCount: 1, createdAt: 1714989600000, category: "HRD/교육" },
  { id: "q166", title: "교육 프로그램 이름이 중요한가요?", text: "그냥 '2024 신입사원 교육' 이렇게 하는 것보다 좀 힙한 이름이 나을까요? 다들 센스 좀 공유해 주세요!", nickname: "네이밍장인", userId: "mock-u166", userRole: "member", jobTitle: "HRD담당", viewCount: 145, answerCount: 1, createdAt: 1715115600000, category: "HRD/교육" },
  { id: "q175", title: "교육 담당자의 성과는 어떻게 설명하면 좋을까요?", text: "매번 만족도만 보고하는데, 경영진분들이 실질적인 효과가 뭐냐고 물어보시면 참 답답하네요 ㅜㅜ", nickname: "성과증명", userId: "mock-u175", userRole: "member", jobTitle: "교육담당", viewCount: 230, answerCount: 1, createdAt: 1715148000000, category: "HRD/교육" }
];

// 전문가 답변 (MOCK_ANSWERS)
const MOCK_ANSWERS: Answer[] = [
  { id: "a1", questionId: "q1", text: "아닙니다. 휴일근무를 보상휴가로 처리할지, 휴일대체로 할지는 노사 합의 사항입니다. 근로자대표와 사전 서면 합의가 있다면 휴일대체가 가능하며, 모든 휴일근무를 보상휴가로 해야 할 법적 의무는 없습니다.", nickname: "위스퍼러", userId: "mock-m1", userRole: "mentor", createdAt: 1714522000000 },
  { id: "a2", questionId: "q2", text: "반드시 개인별로 매번 받을 필요는 없습니다. 근로자대표와 포괄적 서면 합의가 있다면 개별 동의 없이 운영하는 경우가 일반적입니다. 다만 분쟁 예방을 위해 내부 규정이나 공지 형태로 명확히 남겨두는 것이 좋겠죠?", nickname: "전략인사", userId: "mock-m2", userRole: "mentor", createdAt: 1714526000000 },
  { id: "a10", questionId: "q10", text: "법적 기준은 없으며 회사 내규에 따릅니다. 다만 최근 대부분의 기업은 '만 나이'를 기준으로 운영하여 일관성을 유지하고 있습니다. 규정에 명시해두시는 걸 추천드려요.", nickname: "복지마스터", userId: "mock-m10", userRole: "mentor", createdAt: 1714555000000 },
  { id: "a101", questionId: "q101", text: "익명 질문 방식은 임원과 구성원 간 심리적 장벽을 낮추는 데 매우 효과적입니다. 특히 슬라이도나 오픈채팅을 활용해 실시간으로 질문을 받고 답변하는 구조는 신뢰도를 높이는 데 큰 도움이 됩니다.", nickname: "문화리더", userId: "mock-m101", userRole: "mentor", createdAt: 1714882000000 },
  { id: "a131", questionId: "q131", text: "넓은 의미에서는 가능합니다. 리더의 메시지를 통해 조직 방향을 공유하고 인식을 전환한다는 점에서 비형식 학습(Informal Learning)의 한 형태로 볼 수 있습니다. 충분히 HRD 예산 활용 근거가 됩니다.", nickname: "HRD전문가", userId: "mock-m131", userRole: "mentor", createdAt: 1714990000000 }
];
...
export default function HomePage() {
  ...
  const questions = useMemo(() => {
    ...
    // 데이터가 없거나 검색어가 없을 때 샘플 데이터를 합칩니다.
  ...
  const answers = useMemo(() => {
    ...
    if (fetched.length === 0 && selectedQuestionId?.startsWith("q")) {
  ...
  const handleSelectQuestion = (id: string) => {
    if (selectedQuestionId === id) setSelectedQuestionId(null);
      ...
      if (db && !id.startsWith("q")) updateDocumentNonBlocking(doc(db, "questions", id), { viewCount: increment(1) });
    }
  }
