          ...
          <CardContent className="px-8 pb-10">
            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-primary/5 p-1 rounded-2xl mb-8">
                <TabsTrigger value="login" className="rounded-xl font-black data-[state=active]:bg-white data-[state=active]:text-primary">로그인</TabsTrigger>
                <TabsTrigger value="signup" className="rounded-xl font-black data-[state=active]:bg-white data-[state=active]:text-primary">회원가입</TabsTrigger>
              </TabsList>
